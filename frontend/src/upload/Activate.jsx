...
const labels = {
  en: {
    title: 'Set up your upload login',
    intro: 'Use the same phone number you signed with in the contractor form.',
    phone: 'Phone number', password: 'Choose a password', start: 'Create login',
    ...
    resume: 'Already created a login? Finish phone verification',
    resumeHint: 'Enter your phone number to request a new verification code.',
    send: 'Send verification code', restart: 'Create a new login',
    exists: 'This phone already has a login. Sign in, or choose Finish phone verification below.',
    error: 'Account setup could not finish. Check the details and try again.',
  },
  ko: {
    title: '업로드 로그인 만들기', intro: '계약 양식에 서명할 때 사용한 전화번호를 입력해 주세요.',
    phone: '전화번호', password: '비밀번호 설정', start: '로그인 만들기',
    code: '문자 인증번호', confirm: '인증하고 계속', resend: '인증번호 다시 받기',
    back: '로그인으로 돌아가기', working: '잠시만 기다려 주세요…', sent: '휴대전화로 인증번호를 보냈습니다.',
    resume: '계정을 만드셨나요? 전화번호 인증 완료하기',
    resumeHint: '전화번호를 입력하면 새 인증번호를 받을 수 있습니다.',
    send: '인증번호 받기', restart: '새 로그인 만들기',
    exists: '이미 계정이 있는 번호입니다. 로그인하거나 아래에서 전화번호 인증을 완료해 주세요.',
    error: '계정 설정을 완료하지 못했습니다. 입력 내용을 확인하고 다시 시도해 주세요.',
  },
};
