...
export const paymentCopy = {
  en: {
    ...
    reviewHint: 'Your payment details have been saved. Payment follows the agreed review and settlement schedule.',
  ...
  ko: {
    ...
    reviewHint: '지급정보가 저장되었어요. 보수는 계약상 검토와 정산 일정에 따라 지급됩니다.',
